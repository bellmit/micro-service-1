					...
					if(json.code === 0) {
						function getResult(obj) {
							...
							return ['<div class="col-sm-6 col-md-3">',
								    ...
								    '    <div><a href="#" class="btn btn-success btn-sm" onclick="info.api(',obj.prjId,',\'',obj.name,'\')">API</a> ',
								    '		<a href="#" class="btn btn-warning btn-sm" onclick="info.version(',obj.prjId,',\'',obj.name,'\')">版本管理</a>',
								    '  <span class="dropdown opt-more">',
									'<a class="btn btn-default btn-sm dropdown-toggle" href="javascript:;" data-toggle="dropdown">更多...</a>',
