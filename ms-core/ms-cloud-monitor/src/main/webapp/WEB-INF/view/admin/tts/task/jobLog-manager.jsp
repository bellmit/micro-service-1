...
<title>${projectName}-定时任务-任务调用日志</title>
		...
		<div class="c-right">
			<div class="panel panel-success">
				<div class="panel-heading panel-heading-tool">
					<div class="row">
						<div class="col-sm-5 title">任务管理 / <b>任务调用记录</b></div>
						<div class="col-sm-7 text-right">
							<div class="btn-group">
						  		<a href="${webroot}/ttsTaskJob/f-view/manager.shtml?projectid=${param.projectid}" class="btn btn-default btn-sm">返回</a>
...
var info = {
		...
		loadInfo : function(page) {
			...
			JUtil.ajax({
				url : '${webroot}/ttsTaskJobLog/f-json/pageQuery.shtml',
		...
		look : function(id) {
			...
			location = webroot + '/ttsTaskJobLog/f-view/look.shtml?id='+(id?id:'');
		}
};
$(function() {
	info.loadInfo(1);
