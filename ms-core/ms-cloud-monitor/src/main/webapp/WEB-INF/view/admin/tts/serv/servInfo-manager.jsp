<%@page import="com.module.admin.tts.enums.ServInfoStatus"%>
...
<title>${projectName}-定时任务-服务管理</title>
				  	...
				  	<div class="table-tool-panel">
						<div class="row">
							...
							<div class="col-sm-6 text-right">
							  	<div class="btn-group">
								  	<a href="${webroot}/ttsServInfo/f-view/chart.shtml" class="btn btn-success btn-sm">服务图表</a>
							  	</div>
							</div>
						</div>
				  	</div>
...
var info = {
		...
		loadInfo : function(page) {
			...
			JUtil.ajax({
				url : '${webroot}/ttsServInfo/f-json/pageQuery.shtml',
