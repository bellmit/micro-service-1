...
public class MsCloudConsulClientApplication extends WebMvcConfigurerAdapter implements CommandLineRunner {

	private static Logger LOGGER = LoggerFactory.getLogger(MsCloudConsulClientApplication.class);
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(MsCloudConsulClientApplication.class, args);
	}
