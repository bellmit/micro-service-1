...
public class SnowflakeIdWorker {
    ...
    /**
     * 初始信息
     * @param workerId 工作ID (0~1048575)
     * @param datacenterId 数据中心ID (0~1048575)
     */
    private static void init() {
        ...
        //LOGGER.info("maxWorkerId: " + maxWorkerId + " / maxDatacenterId: " + maxDatacenterId);
        //System.out.println("maxWorkerId: " + maxWorkerId + " / maxDatacenterId: " + maxDatacenterId);
     ...
     * @return
     */
    private static long getId(List<Integer> ids) {
    	int num = (int) (Math.random() * maxWorkerId);
    	if(ids.contains(num)) {
    		return getId(ids);
    	}
    	ids.add(num);
