...
import com.ms.biz.a.interceptor.AuthSecurityInterceptor;
...
public class BizServiceAApplication extends WebMvcConfigurerAdapter {

	public static void main(String[] args) {
		SpringApplication.run(BizServiceAApplication.class, args);
